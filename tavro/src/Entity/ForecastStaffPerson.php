...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Repository\Entity\ForecastStaffPersonRepository")
...
{
    /**
     * @ORM\ManyToOne(targetEntity="Tavro\Entity\Forecast", inversedBy="forecast_staff_persons")
    ...
    /**
     * @ORM\OneToOne(targetEntity="Tavro\Entity\Person", mappedBy="forecast_staff_person")
     ...
     * Set staffPerson
     *
     * @param \Tavro\Entity\Person $staffPerson
     *
     * @return ForecastStaffPerson
     */
    public function setStaffPerson(\Tavro\Entity\Person $staffPerson)
    {
