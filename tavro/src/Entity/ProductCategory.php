...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Repository\AccountEntity\ProductCategoryRepository")
...
class ProductCategory extends Entity implements AccountEntityInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Tavro\Entity\Account", inversedBy="product_categories")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Entity\Product", mappedBy="category")
     * @ORM\OrderBy({"id" = "DESC"})
     * @Expose
     */
    protected $products;
