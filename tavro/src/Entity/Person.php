...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Repository\Entity\PersonRepository")
...
class Person extends Entity implements EntityInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Tavro\Entity\User", mappedBy="person", cascade={"remove"})
     */
    protected $user;

    /**
     * @ORM\OneToOne(targetEntity="Tavro\Entity\StaffPerson", mappedBy="person", cascade={"remove"})
     */
     ...
     * @return Person
     */
    public function setStaffPerson(\Tavro\Entity\StaffPerson $staffPerson = null)
    {
     ...
     * Get staffPerson
     *
     * @return \Tavro\Entity\StaffPerson
     */
