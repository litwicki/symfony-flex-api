 ...
 * @xmlName IPPUOM
 * @var IPPUOM
 * @xmlDefinition The UOM type defines the data used to represent a set of equivalent units and the conversion rates to other related units. It allows showing what quantities, prices, rates, and
 *     costs are based on.
 */
class IPPUOM
