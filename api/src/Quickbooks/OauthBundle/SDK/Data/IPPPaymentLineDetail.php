...
class IPPPaymentLineDetail
{
	 ...
	 * @Definition
	Product: ALL
	 * Description: Indicates the unpaid amount of the transaction after this payment is applied in home currency. It is visible only for companies which have multicurrency enabled[br /] Cannot be
