...
class IPPPhysicalAddress
{
	 ...
	 * @Definition
	Product: ALL
	 * Description: Unique identifier of the Intuit entity for the address, mainly used for modifying the address.[br /]Note: There is no SyncToken for this entity because it is always associated
	 *     with the IntuitEntity type that is the top level or parent entity.
	 * @xmlType element
	 * @xmlNamespace http://schema.intuit.com/finance/v3
	 * @xmlMinOccurs 0
	 * @xmlName Id
