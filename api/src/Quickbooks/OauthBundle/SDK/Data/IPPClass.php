 ...
 * @xmlName IPPClass
 * @var IPPClass
 * @xmlDefinition Classes provide a way to track different segments of the business, and to break down the income and expenses for each segment. Classes can apply to all transactions, so they're not
 *     tied to a particular client or project.
 */
class IPPClass
	extends IPPIntuitEntity
{
	 ...
	 * @Definition
	Product: ALL
	 * Description: Output Only. Fully qualified name of the entity. The fully qualified name prepends the topmost parent, followed by each sub element separated by colons. Takes the form of: [br
