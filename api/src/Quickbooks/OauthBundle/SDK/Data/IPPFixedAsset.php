	...
	extends IPPIntuitEntity
{
	...
	public $Vendor;
	/**
	 * @Definition Indicates the Fixed Asset account that tracks the current value of the asset. If the same account is used for all fixed assets, the current balance of this account will represent
	 *     the current total value of the fixed assets.[br /]
	 * [br /]
	...
	public $AssetNum;
	/**
	 * @Definition QBW only: The total cost of the fixed asset. This can include the cost of improvements or repairs. This amount is used to calculate depreciation. Maintained by the QB Fixed Asset
	 *     Manager.
	 * @xmlType element
	 * @xmlNamespace http://schema.intuit.com/finance/v3
	 * @xmlMinOccurs 0
