 ...
 * @xmlDefinition
Product: ALL
 * Description: Custom field that can be added to an entity. This type is not extended from IntuitEntity as CustomField can not be manipulated as independent entity and will always be considered in
 *     association with another top level Intuit entity.
 */
