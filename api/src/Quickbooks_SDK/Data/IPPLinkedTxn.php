 ...
 * @var IPPLinkedTxn
 * @xmlDefinition That minimal subset of transaction information which is included on another  transaction, so that a client viewing the second transaction entity need not make an additional request
 *     to the service in order to render it in human readable form.  (e.g a payment needs to refer to an invoice by number)
 */
class IPPLinkedTxn
{
