	...
	extends IPPIntuitEntity
{
	 ...
	 * @Definition
	Product: QBW
	 * Description: Reference to the Employee, if that is the SalesRep type. One of the three entity references (either the Name or the ID of the Employee, OtherName, or Vendor) is required for the
	 *     Create request. Required: QBW
	 * @xmlType element
	 * @xmlNamespace http://schema.intuit.com/finance/v3
	 * @xmlMinOccurs 0
	 * @xmlName EmployeeRef
	 ...
	 * @Definition
	Product: QBW
	 * Description: Reference to the Vendor, if that is the SalesRep type. One of the three entity references (either the Name or the ID of the Employee, OtherName, or Vendor) is required for the
	 *     Create request. Required: QBW
	 * @xmlType element
	 * @xmlNamespace http://schema.intuit.com/finance/v3
	 * @xmlMinOccurs 0
	 ...
	 * @Definition
	Product: QBW
	 * Description: Reference to the OtherName, if that is the SalesRep type. One of the three entity references (either the Name or the ID of the Employee, OtherName, or Vendor) is required for the
	 *     Create request. Required: QBW
	 * @xmlType element
	 * @xmlNamespace http://schema.intuit.com/finance/v3
	 * @xmlMinOccurs 0
