	...
	extends IPPTransaction
{
	...
	public $VendorRef;
	/**
	 * @Definition Specifies which AP account the bill will be credited to. Many/most small businesses have a single AP account, so the account is implied.  When specified, the account must be a
	 *     Liability account, and further, the sub-type must be of type "Payables"
