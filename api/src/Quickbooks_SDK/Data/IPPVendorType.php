 ...
 * @var IPPVendorType
 * @xmlDefinition Vendor types allow categorizing vendors in ways that are meaningful to the business. For example, one could set up vendor types so that they indicate a vendor's industry or
 *     geographic location. The categorization then can be used for reporting.
 */
class IPPVendorType
