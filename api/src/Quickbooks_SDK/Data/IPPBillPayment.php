	...
	extends IPPTransaction
{
	...
	public $VendorRef;
	/**
	 * @Definition Optional AP account specification for bill payment transactions.  Most small businesses have a single AP account, so the account is implied.   When specified, the account must be a
	 *     liability account - and further, must be of the sub-type "Payables".
	 * [b]QuickBooks Notes[/b][br /]
