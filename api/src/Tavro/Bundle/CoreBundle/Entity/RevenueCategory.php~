 ...
 *
 */
class RevenueCategory extends Entity implements EntityInterface
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Tavro\Bundle\CoreBundle\Entity\Organization", inversedBy="revenue_categories")
