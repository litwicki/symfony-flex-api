...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Bundle\CoreBundle\Repository\Entity\MetricRepository")
...
class Metric extends Entity implements AccountEntityInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Tavro\Bundle\CoreBundle\Entity\Account", inversedBy="metrics")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\DashboardMetric", mappedBy="metric", cascade={"remove"})
     */
