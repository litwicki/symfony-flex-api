...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Bundle\CoreBundle\Repository\Entity\CommentRepository")
...
class Comment extends Entity implements EntityInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\ForecastComment", mappedBy="comment", cascade={"remove"})
     */
