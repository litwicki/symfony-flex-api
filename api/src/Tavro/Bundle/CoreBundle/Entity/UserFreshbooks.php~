...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Bundle\CoreBundle\Doctrine\Repository\Entity\UserFreshbooksRepository")
 * @Table(name="tavro_user_freshbooks")
 * @ORM\HasLifecycleCallbacks
 *
 */
class UserFreshbooks extends Entity implements EntityInterface
{
    ...
    {
        return openssl_decrypt($string, "AES-256-CBC", '8ePFvtAtHtZKfiN40OcaTmsuzEkuHBI2', 0, '5728582182961174');
    }

    public static function staticEncrypt($string)
    {
        return openssl_encrypt($string, "AES-256-CBC", '8ePFvtAtHtZKfiN40OcaTmsuzEkuHBI2', 0, '5728582182961174');
    }
