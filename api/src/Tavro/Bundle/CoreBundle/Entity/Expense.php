 ...
 * @ORM\Table(name="tavro_expense", indexes={@ORM\Index(name="NODE_TYPE", columns={"type"})})
 *
 */
class Expense extends ApiEntity
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\ExpenseRead", mappedBy="expense", cascade={"remove"})
     */
    protected $expenses_read;
    ...
    public function __construct()
    {
        ...
        $this->expenses_read = new \Doctrine\Common\Collections\ArrayCollection();
        $this->status = 1;
        $now = new \DateTime();
