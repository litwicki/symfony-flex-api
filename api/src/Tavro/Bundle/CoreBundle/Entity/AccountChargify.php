...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Bundle\CoreBundle\Repository\Entity\AccountChargifyRepository")
...
class AccountChargify extends Entity implements AccountEntityInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Tavro\Bundle\CoreBundle\Entity\Account", inversedBy="account_chargify")
