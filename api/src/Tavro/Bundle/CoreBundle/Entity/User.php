...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Tavro\Bundle\CoreBundle\Repository\Entity\UserRepository")
...
{
    const CREATE_EVENT_CLASS    = 'Tavro\Bundle\CoreBundle\Event\User\UserSignupEvent';
    const DELETE_EVENT_CLASS    = 'Tavro\Bundle\CoreBundle\Event\User\UserDeleteEvent';
    const UPDATE_EVENT_CLASS    = 'Tavro\Bundle\CoreBundle\Event\User\UserUpdateEvent';
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\Forecast", mappedBy="user")
     * @ORM\OrderBy({"id" = "DESC"})
     */
    protected $forecasts;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\Syndicate", mappedBy="user")
     * @ORM\OrderBy({"id" = "DESC"})
     */
    protected $syndicates;

    /**
     * @ORM\ManyToMany(targetEntity="Tavro\Bundle\CoreBundle\Entity\Syndicate", mappedBy="investors")
     * @ORM\OrderBy({"id" = "DESC"})
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="Tavro\Bundle\CoreBundle\Entity\Person", inversedBy="user")
     ...
     * Add syndicate
     *
     * @param \Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicate
     *
     * @return User
     */
    public function addSyndicate(\Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicate)
    {
     ...
     * @param \Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicate
     */
    public function removeSyndicate(\Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicate)
    {
     ...
     *
     * @param \Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicateMembership
     *
     * @return User
     */
    public function addSyndicateMembership(\Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicateMembership)
    {
     ...
     * @param \Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicateMembership
     */
    public function removeSyndicateMembership(\Tavro\Bundle\CoreBundle\Entity\Syndicate $syndicateMembership)
    {
