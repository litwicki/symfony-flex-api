...
use Tavro\Bundle\CoreBundle\Entity\RevenueComment;
...
/**
 * Class RevenueCommentVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class RevenueCommentVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\RevenueComment $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, RevenueComment $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the RevenueComment can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their RevenueComment within 30 minutes of RevenueCommenting
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof RevenueComment;
    }
