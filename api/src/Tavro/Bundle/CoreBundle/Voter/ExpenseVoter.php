 ...
 */
class ExpenseVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     * @return int
     */
    public function checkAccess($user, Expense $entity, $attribute)
    {
        ...
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their Expense within 30 minutes of Expenseing
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof Expense;
    }
