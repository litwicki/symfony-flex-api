...
/**
 * Class RevenueServiceVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class RevenueServiceVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\RevenueService $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, RevenueService $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the RevenueService can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their RevenueService within 30 minutes of RevenueServiceing
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof RevenueService;
    }
