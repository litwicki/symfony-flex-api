 ...
 */
class ProductCategoryVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     * @return int
     */
    public function checkAccess($user, ProductCategory $entity, $attribute)
    {
    ...
    public function supportsClass($class) {
        return $class instanceof ProductCategory;
    }
