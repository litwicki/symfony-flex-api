...
/**
 * Class FundingRoundCommentVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class FundingRoundCommentVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\FundingRoundComment $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, FundingRoundComment $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the FundingRoundComment can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their FundingRoundComment within 30 minutes of FundingRoundCommenting
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof FundingRoundComment;
    }
