 ...
 */
class ServiceVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\Service $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, Service $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the Service can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their Service within 30 minutes of Serviceing
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof Service;
    }
