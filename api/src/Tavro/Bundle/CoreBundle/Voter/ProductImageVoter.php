...
use Tavro\Bundle\CoreBundle\Entity\ProductImage;
...
/**
 * Class ProductImageVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class ProductImageVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     * @return int
     */
    public function checkAccess($user, ProductImage $entity, $attribute)
    {
    ...
    public function supportsClass($class) {
        return $class instanceof ProductImage;
    }
