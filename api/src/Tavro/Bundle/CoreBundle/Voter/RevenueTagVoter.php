...
use Tavro\Bundle\CoreBundle\Entity\RevenueTag;
...
/**
 * Class RevenueTagVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class RevenueTagVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\RevenueTag $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, RevenueTag $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the RevenueTag can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their RevenueTag within 30 minutes of RevenueTaging
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof RevenueTag;
    }
