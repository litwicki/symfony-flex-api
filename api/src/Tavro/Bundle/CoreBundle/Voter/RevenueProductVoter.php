...
/**
 * Class RevenueProductVoter
 *
 * @package Tavro\Bundle\CoreBundle\Voter
 */
class RevenueProductVoter implements VoterInterface, ContainerAwareInterface
{
     ...
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\RevenueProduct $entity
     * @param string  $attribute
     *
     * @throws \Exception
     * @return int
     */
    public function checkAccess($user, RevenueProduct $entity, $attribute)
    {
        ...
        /**
         * Only Admins, or the author of the RevenueProduct can edit
         */
        if($attribute == self::EDIT || $attribute == self::PATCH) {
            ...
            if($user->getId() === $entity->getUser()->getId()) {
                ...
                /**
                 * Only allow the "author" to edit their RevenueProduct within 30 minutes of RevenueProducting
                 */
                if($now < $modifyDate) {
                    return VoterInterface::ACCESS_GRANTED;
                }
    ...
    public function supportsClass($class) {
        return $class instanceof RevenueProduct;
    }
