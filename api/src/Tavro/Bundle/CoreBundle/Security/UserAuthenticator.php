...
namespace Tavro\Bundle\CoreBundle\Security;
...
class UserAuthenticator implements SimpleFormAuthenticatorInterface
{
    ...
    /**
     * @param \Tavro\Bundle\CoreBundle\Services\PasswordEncoder $encoder
     * @param \Tavro\Bundle\CoreBundle\Security\UserProvider $provider
     */
