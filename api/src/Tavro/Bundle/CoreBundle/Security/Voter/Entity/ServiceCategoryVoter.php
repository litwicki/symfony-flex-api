 ...
 */
class ServiceCategoryVoter extends TavroVoter implements VoterInterface
{
    /**
     * Allows full access to members belonging to the entity, view access to outside admins.
     *
     * @param User $user
     * @param \Tavro\Bundle\CoreBundle\Entity\ServiceCategory $entity
    ...
    public function checkAccess($user, ServiceCategory $entity, $attribute)
    {
        ...
        $checkOrganization = $this->checkOrganization($entity->getService()->getOrganization(), $user);
        ...
        /**
         * Only Admins, or the author of the ServiceCategory can edit
         */
    ...
    public function supportsClass($class) {
        return $class instanceof ServiceCategory;
    }
