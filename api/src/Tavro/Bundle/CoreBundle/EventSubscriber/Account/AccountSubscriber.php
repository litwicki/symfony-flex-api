...
namespace Tavro\Bundle\CoreBundle\EventSubscriber\Account;
...
use Tavro\Bundle\CoreBundle\Event\Account\AccountCreateEvent;
use Tavro\Bundle\CoreBundle\Event\Account\AccountDeactivateEvent;
use Tavro\Bundle\CoreBundle\Event\Account\AccountDeleteEvent;
use Tavro\Bundle\CoreBundle\Event\Account\AccountOwnerDeactivateEvent;
use Tavro\Bundle\CoreBundle\Mail\TavroMailer;
...
class AccountSubscriber implements EventSubscriberInterface
{
     ...
     *
     * @param \Tavro\Bundle\CoreBundle\Event\Account\AccountCreateEvent $event
     */
     ...
     *
     * @param \Tavro\Bundle\CoreBundle\Event\Account\AccountDeleteEvent $event
     */
     ...
     *
     * @param \Tavro\Bundle\CoreBundle\Event\Account\AccountDeactivateEvent $event
     */
     ...
     *
     * @param \Tavro\Bundle\CoreBundle\Event\Account\AccountOwnerDeactivateEvent $event
     */
