 ...
 */
class Version20160301000430 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_comment (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_24219FEFA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_customer (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, organization_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, job_title VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, zip VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F538095EE7927C74 (email), INDEX IDX_F538095EA76ED395 (user_id), INDEX IDX_F538095E32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_customer_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, customer_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_5DF54DDBF8697D13 (comment_id), INDEX IDX_5DF54DDB9395C3F3 (customer_id), INDEX CUSTOMER_COMMENT (comment_id, customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, organization_id INT NOT NULL, customer_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, expense_date DATETIME NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_9D6F402512469DE2 (category_id), INDEX IDX_9D6F4025A76ED395 (user_id), INDEX IDX_9D6F402532C8A3DE (organization_id), INDEX IDX_9D6F40259395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_1571603132C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, expense_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_C595F474F8697D13 (comment_id), INDEX IDX_C595F474F395DB7B (expense_id), INDEX NODE_COMMENT (comment_id, expense_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense_tag (id INT AUTO_INCREMENT NOT NULL, tag_id INT NOT NULL, expense_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_C54FE424BAD26311 (tag_id), INDEX IDX_C54FE424F395DB7B (expense_id), INDEX EXPENSE_TAG (tag_id, expense_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_funding_round (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, prospectus VARCHAR(255) DEFAULT NULL, share_price DOUBLE PRECISION DEFAULT \'0\', total_shares INT DEFAULT 0, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_F2ADB75B32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_funding_round_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, funding_round_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_9AD42CA2F8697D13 (comment_id), INDEX IDX_9AD42CA2D01758B0 (funding_round_id), INDEX FUNDING_ROUND_COMMENT (comment_id, funding_round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_funding_round_shareholder (id INT AUTO_INCREMENT NOT NULL, shareholder_id INT NOT NULL, funding_round_id INT NOT NULL, organization_id INT NOT NULL, shares INT DEFAULT 0, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_54BC254D9D59475 (shareholder_id), INDEX IDX_54BC254DD01758B0 (funding_round_id), INDEX IDX_54BC254D32C8A3DE (organization_id), INDEX ORGANIZATION_SHAREHOLDER (shareholder_id, funding_round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_image (id INT AUTO_INCREMENT NOT NULL, aws_url VARCHAR(500) NOT NULL, bucket VARCHAR(32) NOT NULL, directory VARCHAR(32) NOT NULL, aws_key VARCHAR(500) NOT NULL, original_filename VARCHAR(500) NOT NULL, mime_type VARCHAR(500) NOT NULL, filesize INT NOT NULL, height INT NOT NULL, width INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_node (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, organization_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, display_date DATETIME DEFAULT NULL, views INT DEFAULT 0, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_A12253AAA76ED395 (user_id), INDEX IDX_A12253AA32C8A3DE (organization_id), INDEX NODE_TYPE (type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_node_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, node_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_CEAFA964F8697D13 (comment_id), INDEX IDX_CEAFA964460D9FD7 (node_id), INDEX NODE_COMMENT (comment_id, node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_node_read (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, node_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_AA880921A76ED395 (user_id), INDEX IDX_AA880921460D9FD7 (node_id), INDEX USER_NODE_READ (user_id, node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_node_tag (id INT AUTO_INCREMENT NOT NULL, tag_id INT NOT NULL, node_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_4AD12AFBAD26311 (tag_id), INDEX IDX_4AD12AF460D9FD7 (node_id), INDEX NODE_TAG (tag_id, node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_organization (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(500) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_3D3DDD06A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, organization_id INT NOT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, cost DOUBLE PRECISION DEFAULT \'0\', body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_631FC92E12469DE2 (category_id), INDEX IDX_631FC92E32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_product_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_18A0C85F32C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_product_image (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, product_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_D44D349F3DA5256D (image_id), INDEX IDX_D44D349F4584665A (product_id), INDEX PRODUCT_IMAGE (image_id, product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, customer_id INT DEFAULT NULL, organization_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_5944A10612469DE2 (category_id), INDEX IDX_5944A106A76ED395 (user_id), INDEX IDX_5944A1069395C3F3 (customer_id), INDEX IDX_5944A10632C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_revenue_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, revenue_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_6645878CF8697D13 (comment_id), INDEX IDX_6645878C224718EB (revenue_id), INDEX NODE_COMMENT (comment_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, revenue_id INT NOT NULL, qty INT DEFAULT 1, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_217BD14D4584665A (product_id), INDEX IDX_217BD14D224718EB (revenue_id), INDEX REVENUE_PRODUCT (product_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_service (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, revenue_id INT NOT NULL, qty INT DEFAULT 1, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_13AC4F32ED5CA9E6 (service_id), INDEX IDX_13AC4F32224718EB (revenue_id), INDEX REVENUE_SERVICE (service_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_tag (id INT AUTO_INCREMENT NOT NULL, tag_id INT NOT NULL, revenue_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_3591A5A3BAD26311 (tag_id), INDEX IDX_3591A5A3224718EB (revenue_id), INDEX REVENUE_TAG (tag_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_role (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, role VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_733431855E237E06 (name), UNIQUE INDEX UNIQ_7334318557698A6A (role), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_service (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, organization_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, type VARCHAR(255) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_51C8575112469DE2 (category_id), INDEX IDX_51C8575132C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_service_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_2A66F9F532C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_service_image (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, service_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_DC63A2243DA5256D (image_id), INDEX IDX_DC63A224ED5CA9E6 (service_id), INDEX PRODUCT_IMAGE (image_id, service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_shareholder (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, zip VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, notes VARCHAR(8000) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_BFC86E97E7927C74 (email), INDEX IDX_BFC86E97A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_tag (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, tag VARCHAR(500) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_EA91FE7032C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_user (id INT AUTO_INCREMENT NOT NULL, avatar_image_id INT DEFAULT NULL, user_quickbooks_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, password_token VARCHAR(255) DEFAULT NULL, password_token_expire DATETIME DEFAULT NULL, salt VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, signature VARCHAR(500) DEFAULT NULL, last_online_date DATETIME DEFAULT NULL, api_key VARCHAR(255) NOT NULL, api_password VARCHAR(255) NOT NULL, api_enabled TINYINT(1) NOT NULL, guid VARCHAR(255) NOT NULL, user_ip VARCHAR(255) DEFAULT NULL, gender VARCHAR(32) DEFAULT NULL, user_agent VARCHAR(255) DEFAULT NULL, birthday DATE DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A9CE6DA6F85E0677 (username), UNIQUE INDEX UNIQ_A9CE6DA6E7927C74 (email), INDEX IDX_A9CE6DA65C18B4B1 (avatar_image_id), UNIQUE INDEX UNIQ_A9CE6DA6EDF4C3C9 (user_quickbooks_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
