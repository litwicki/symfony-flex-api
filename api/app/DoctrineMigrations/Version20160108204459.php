 ...
 */
class Version20160108204459 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_expense (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_9D6F4025989D9B62 (slug), INDEX IDX_9D6F402512469DE2 (category_id), INDEX IDX_9D6F4025A76ED395 (user_id), INDEX IDX_9D6F402532C8A3DE (organization_id), INDEX IDX_9D6F40252793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(500) NOT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_15716031989D9B62 (slug), INDEX IDX_1571603132C8A3DE (organization_id), INDEX IDX_157160312793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_funding (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_63581C55989D9B62 (slug), INDEX IDX_63581C5532C8A3DE (organization_id), INDEX IDX_63581C552793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_funding_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, funding_id INT NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, INDEX IDX_63CB3F0EF8697D13 (comment_id), INDEX IDX_63CB3F0E9D70482 (funding_id), INDEX NODE_COMMENT (comment_id, funding_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_product_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(500) NOT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_18A0C85F989D9B62 (slug), INDEX IDX_18A0C85F32C8A3DE (organization_id), INDEX IDX_18A0C85F2793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_5944A106989D9B62 (slug), INDEX IDX_5944A10612469DE2 (category_id), INDEX IDX_5944A106A76ED395 (user_id), INDEX IDX_5944A10632C8A3DE (organization_id), INDEX IDX_5944A1062793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(500) NOT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_A6B4CA6C989D9B62 (slug), INDEX IDX_A6B4CA6C32C8A3DE (organization_id), INDEX IDX_A6B4CA6C2793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_service_category (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(500) NOT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_2A66F9F5989D9B62 (slug), INDEX IDX_2A66F9F532C8A3DE (organization_id), INDEX IDX_2A66F9F52793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_shareholder (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, address2 VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, zip VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, shares VARCHAR(255) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_expense_category ADD CONSTRAINT FK_157160312793CC5E FOREIGN KEY (updated_by_user_id) REFERENCES tavro_user (id)');
        ...
        $this->addSql('ALTER TABLE tavro_funding ADD CONSTRAINT FK_63581C5532C8A3DE FOREIGN KEY (organization_id) REFERENCES tavro_organization (id)');
        $this->addSql('ALTER TABLE tavro_funding ADD CONSTRAINT FK_63581C552793CC5E FOREIGN KEY (updated_by_user_id) REFERENCES tavro_user (id)');
        $this->addSql('ALTER TABLE tavro_funding_comment ADD CONSTRAINT FK_63CB3F0EF8697D13 FOREIGN KEY (comment_id) REFERENCES tavro_comment (id)');
        $this->addSql('ALTER TABLE tavro_funding_comment ADD CONSTRAINT FK_63CB3F0E9D70482 FOREIGN KEY (funding_id) REFERENCES tavro_funding (id)');
        ...
        $this->addSql('ALTER TABLE tavro_product_category ADD CONSTRAINT FK_18A0C85F2793CC5E FOREIGN KEY (updated_by_user_id) REFERENCES tavro_user (id)');
        ...
        $this->addSql('ALTER TABLE tavro_revenue_category ADD CONSTRAINT FK_A6B4CA6C2793CC5E FOREIGN KEY (updated_by_user_id) REFERENCES tavro_user (id)');
        ...
        $this->addSql('ALTER TABLE tavro_service_category ADD CONSTRAINT FK_2A66F9F52793CC5E FOREIGN KEY (updated_by_user_id) REFERENCES tavro_user (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tavro_funding_comment DROP FOREIGN KEY FK_63CB3F0EF8697D13');
        ...
        $this->addSql('ALTER TABLE tavro_funding_comment DROP FOREIGN KEY FK_63CB3F0E9D70482');
        ...
        $this->addSql('ALTER TABLE tavro_funding DROP FOREIGN KEY FK_63581C5532C8A3DE');
        ...
        $this->addSql('ALTER TABLE tavro_expense_category DROP FOREIGN KEY FK_157160312793CC5E');
        $this->addSql('ALTER TABLE tavro_funding DROP FOREIGN KEY FK_63581C552793CC5E');
        ...
        $this->addSql('ALTER TABLE tavro_product_category DROP FOREIGN KEY FK_18A0C85F2793CC5E');
        ...
        $this->addSql('ALTER TABLE tavro_revenue_category DROP FOREIGN KEY FK_A6B4CA6C2793CC5E');
        $this->addSql('ALTER TABLE tavro_service DROP FOREIGN KEY FK_51C857512793CC5E');
        $this->addSql('ALTER TABLE tavro_service_category DROP FOREIGN KEY FK_2A66F9F52793CC5E');
        ...
        $this->addSql('DROP TABLE tavro_funding');
        $this->addSql('DROP TABLE tavro_funding_comment');
