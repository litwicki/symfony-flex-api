 ...
 */
class Version20160211035853 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_organization_shareholder (id INT AUTO_INCREMENT NOT NULL, shareholder_id INT NOT NULL, organization_id INT NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, INDEX IDX_E2C6F4639D59475 (shareholder_id), INDEX IDX_E2C6F46332C8A3DE (organization_id), INDEX ORGANIZATION_SHAREHOLDER (shareholder_id, organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_shareholder (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, zip VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, shares INT DEFAULT 0, notes VARCHAR(8000) DEFAULT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, INDEX IDX_BFC86E97A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_organization_shareholder ADD CONSTRAINT FK_E2C6F4639D59475 FOREIGN KEY (shareholder_id) REFERENCES tavro_shareholder (id)');
        $this->addSql('ALTER TABLE tavro_organization_shareholder ADD CONSTRAINT FK_E2C6F46332C8A3DE FOREIGN KEY (organization_id) REFERENCES tavro_organization (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tavro_organization_shareholder DROP FOREIGN KEY FK_E2C6F46332C8A3DE');
        ...
        $this->addSql('ALTER TABLE tavro_organization_shareholder DROP FOREIGN KEY FK_E2C6F4639D59475');
        ...
        $this->addSql('DROP TABLE tavro_organization_shareholder');
