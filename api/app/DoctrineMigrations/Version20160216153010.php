 ...
 */
class Version20160216153010 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_revenue_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, revenue_id INT NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, INDEX IDX_217BD14D4584665A (product_id), INDEX IDX_217BD14D224718EB (revenue_id), INDEX REVENUE_PRODUCT (product_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_service (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, revenue_id INT NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME NOT NULL, INDEX IDX_13AC4F32ED5CA9E6 (service_id), INDEX IDX_13AC4F32224718EB (revenue_id), INDEX REVENUE_PRODUCT (service_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
