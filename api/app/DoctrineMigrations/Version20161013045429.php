 ...
 */
class Version20161013045429 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_forecast (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, title VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_5E9DFF139B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_revenue (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_5944A10632C8A3DE (organization_id), INDEX IDX_5944A10612469DE2 (category_id), INDEX IDX_5944A106A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_service (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, qbo_id INT DEFAULT NULL, discount_amount DOUBLE PRECISION DEFAULT \'0\', discount_percent DOUBLE PRECISION DEFAULT \'0\', body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_51C85751680BA09D (qbo_id), INDEX IDX_51C857519B6B5FBA (account_id), INDEX IDX_51C8575112469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_staff_person (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, person_id INT NOT NULL, job_title VARCHAR(255) DEFAULT NULL, starting_salary INT DEFAULT 0 NOT NULL, current_salary INT DEFAULT 0 NOT NULL, hire_date DATETIME DEFAULT NULL, start_date DATETIME DEFAULT NULL, termination_date DATETIME DEFAULT NULL, resignation_date DATETIME DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_CD72DDB79B6B5FBA (account_id), UNIQUE INDEX UNIQ_CD72DDB7217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_person ADD CONSTRAINT FK_B189700C10376B08 FOREIGN KEY (staff_person_id) REFERENCES tavro_staff_person (id)');
        ...
        $this->addSql('ALTER TABLE tavro_staff_person ADD CONSTRAINT FK_CD72DDB79B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_staff_person ADD CONSTRAINT FK_CD72DDB7217BBB47 FOREIGN KEY (person_id) REFERENCES tavro_person (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tavro_staff_person DROP FOREIGN KEY FK_CD72DDB79B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_forecast_staff_person DROP FOREIGN KEY FK_E170B0BD10376B08');
        $this->addSql('ALTER TABLE tavro_shareholder DROP FOREIGN KEY FK_BFC86E97217BBB47');
        $this->addSql('ALTER TABLE tavro_staff_person DROP FOREIGN KEY FK_CD72DDB7217BBB47');
        ...
        $this->addSql('ALTER TABLE tavro_forecast_revenue DROP FOREIGN KEY FK_DB80853712469DE2');
        ...
        $this->addSql('ALTER TABLE tavro_person DROP FOREIGN KEY FK_B189700C10376B08');
        ...
        $this->addSql('ALTER TABLE tavro_forecast_expense DROP FOREIGN KEY FK_1FAB6414A76ED395');
        $this->addSql('ALTER TABLE tavro_forecast_revenue DROP FOREIGN KEY FK_DB808537A76ED395');
        ...
        $this->addSql('DROP TABLE tavro_forecast');
        $this->addSql('DROP TABLE tavro_forecast_expense');
        $this->addSql('DROP TABLE tavro_forecast_revenue');
        $this->addSql('DROP TABLE tavro_forecast_staff_person');
        ...
        $this->addSql('DROP TABLE tavro_staff_person');
