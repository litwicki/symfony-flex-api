 ...
 */
class Version20160218024308 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_funding_round_shareholder (id INT AUTO_INCREMENT NOT NULL, shareholder_id INT NOT NULL, funding_round_id INT NOT NULL, organization_id INT NOT NULL, shares INT DEFAULT 0, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_54BC254D9D59475 (shareholder_id), INDEX IDX_54BC254DD01758B0 (funding_round_id), INDEX IDX_54BC254D32C8A3DE (organization_id), INDEX ORGANIZATION_SHAREHOLDER (shareholder_id, funding_round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_revenue (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, customer_id INT DEFAULT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5944A106989D9B62 (slug), INDEX IDX_5944A10612469DE2 (category_id), INDEX IDX_5944A106A76ED395 (user_id), INDEX IDX_5944A1069395C3F3 (customer_id), INDEX IDX_5944A10632C8A3DE (organization_id), INDEX IDX_5944A1062793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_revenue_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, revenue_id INT NOT NULL, qty INT DEFAULT 1, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_217BD14D4584665A (product_id), INDEX IDX_217BD14D224718EB (revenue_id), INDEX REVENUE_PRODUCT (product_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_revenue_service (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, revenue_id INT NOT NULL, qty INT DEFAULT 1, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_13AC4F32ED5CA9E6 (service_id), INDEX IDX_13AC4F32224718EB (revenue_id), INDEX REVENUE_SERVICE (service_id, revenue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_service (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, organization_id INT NOT NULL, updated_by_user_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, type VARCHAR(255) NOT NULL, title VARCHAR(500) DEFAULT NULL, slug VARCHAR(64) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_51C85751989D9B62 (slug), INDEX IDX_51C8575112469DE2 (category_id), INDEX IDX_51C8575132C8A3DE (organization_id), INDEX IDX_51C857512793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE UserQuickbooks (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, access_token VARCHAR(255) NOT NULL, access_token_secret VARCHAR(255) NOT NULL, consumer_key VARCHAR(255) NOT NULL, consumer_secret VARCHAR(255) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_14809845B6A2DD68 (access_token), UNIQUE INDEX UNIQ_148098458196DFA5 (access_token_secret), UNIQUE INDEX UNIQ_14809845D2702362 (consumer_key), UNIQUE INDEX UNIQ_1480984592086127 (consumer_secret), UNIQUE INDEX UNIQ_14809845A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_variable (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, slug VARCHAR(100) NOT NULL, value VARCHAR(8000) NOT NULL, status INT NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_B84C00DA989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_user ADD CONSTRAINT FK_A9CE6DA6EDF4C3C9 FOREIGN KEY (user_quickbooks_id) REFERENCES UserQuickbooks (id)');
        ...
        $this->addSql('ALTER TABLE UserQuickbooks ADD CONSTRAINT FK_14809845A76ED395 FOREIGN KEY (user_id) REFERENCES tavro_user (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE UserQuickbooks DROP FOREIGN KEY FK_14809845A76ED395');
        ...
        $this->addSql('DROP TABLE UserQuickbooks');
