 ...
 */
class Version20160912073621 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_user_account (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, user_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_D9E8F6D49B6B5FBA (account_id), INDEX IDX_D9E8F6D4A76ED395 (user_id), INDEX USER_ORGANIZATION (account_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_contact (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, organization_id INT DEFAULT NULL, person_id INT DEFAULT NULL, account_id INT NOT NULL, job_title VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_FC372BBBA76ED395 (user_id), INDEX IDX_FC372BBB32C8A3DE (organization_id), INDEX IDX_FC372BBB217BBB47 (person_id), INDEX IDX_FC372BBB9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_expense (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, organization_id INT NOT NULL, account_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, expense_date DATETIME NOT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_9D6F402512469DE2 (category_id), INDEX IDX_9D6F4025A76ED395 (user_id), INDEX IDX_9D6F402532C8A3DE (organization_id), INDEX IDX_9D6F40259B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_node (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, account_id INT NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, display_date DATETIME DEFAULT NULL, views INT DEFAULT 0, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_A12253AAA76ED395 (user_id), INDEX IDX_A12253AA9B6B5FBA (account_id), INDEX NODE_TYPE (type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_organization (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, title VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_3D3DDD069B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_contact_comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, contact_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_32A19ECFF8697D13 (comment_id), INDEX IDX_32A19ECFE7A1254A (contact_id), INDEX CUSTOMER_COMMENT (comment_id, contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_person (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, middle_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, suffix VARCHAR(255) DEFAULT NULL, gender VARCHAR(32) DEFAULT NULL, birthday DATE DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_B189700C9B6B5FBA (account_id), INDEX ACCOUNT_PERSON (id, account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, account_id INT NOT NULL, title VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, cost DOUBLE PRECISION DEFAULT \'0\', body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_631FC92E12469DE2 (category_id), INDEX IDX_631FC92E9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_revenue (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, organization_id INT DEFAULT NULL, account_id INT NOT NULL, type VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_5944A10612469DE2 (category_id), INDEX IDX_5944A106A76ED395 (user_id), INDEX IDX_5944A10632C8A3DE (organization_id), INDEX IDX_5944A1069B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_service (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, organization_id INT NOT NULL, account_id INT NOT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, type VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_51C8575112469DE2 (category_id), INDEX IDX_51C8575132C8A3DE (organization_id), INDEX IDX_51C857519B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_shareholder (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, account_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_BFC86E97217BBB47 (person_id), INDEX IDX_BFC86E979B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_tag (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, account_id INT NOT NULL, tag VARCHAR(500) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_EA91FE7032C8A3DE (organization_id), INDEX IDX_EA91FE709B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_user (id INT AUTO_INCREMENT NOT NULL, avatar_image_id INT DEFAULT NULL, person_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, password_token VARCHAR(255) DEFAULT NULL, password_token_expire DATETIME DEFAULT NULL, salt VARCHAR(255) NOT NULL, signature VARCHAR(500) DEFAULT NULL, last_online_date DATETIME DEFAULT NULL, api_key VARCHAR(255) NOT NULL, api_password VARCHAR(255) NOT NULL, api_enabled TINYINT(1) NOT NULL, guid VARCHAR(255) NOT NULL, user_ip VARCHAR(255) DEFAULT NULL, user_agent VARCHAR(255) DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A9CE6DA6F85E0677 (username), INDEX IDX_A9CE6DA65C18B4B1 (avatar_image_id), INDEX IDX_A9CE6DA6217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_user_account ADD CONSTRAINT FK_D9E8F6D49B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_user_account ADD CONSTRAINT FK_D9E8F6D4A76ED395 FOREIGN KEY (user_id) REFERENCES tavro_user (id)');
        ...
        $this->addSql('ALTER TABLE tavro_contact ADD CONSTRAINT FK_FC372BBB9B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_contact_comment ADD CONSTRAINT FK_32A19ECFF8697D13 FOREIGN KEY (comment_id) REFERENCES tavro_comment (id)');
        $this->addSql('ALTER TABLE tavro_contact_comment ADD CONSTRAINT FK_32A19ECFE7A1254A FOREIGN KEY (contact_id) REFERENCES tavro_contact (id)');
        $this->addSql('ALTER TABLE tavro_person ADD CONSTRAINT FK_B189700C9B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_shareholder ADD CONSTRAINT FK_BFC86E979B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_tag ADD CONSTRAINT FK_EA91FE709B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tavro_user_account DROP FOREIGN KEY FK_D9E8F6D49B6B5FBA');
        $this->addSql('ALTER TABLE tavro_contact DROP FOREIGN KEY FK_FC372BBB9B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_person DROP FOREIGN KEY FK_B189700C9B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_shareholder DROP FOREIGN KEY FK_BFC86E979B6B5FBA');
        $this->addSql('ALTER TABLE tavro_tag DROP FOREIGN KEY FK_EA91FE709B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_contact_comment DROP FOREIGN KEY FK_32A19ECFF8697D13');
        $this->addSql('ALTER TABLE tavro_revenue_comment DROP FOREIGN KEY FK_6645878CF8697D13');
        $this->addSql('ALTER TABLE tavro_contact_comment DROP FOREIGN KEY FK_32A19ECFE7A1254A');
        ...
        $this->addSql('ALTER TABLE tavro_user_account DROP FOREIGN KEY FK_D9E8F6D4A76ED395');
        ...
        $this->addSql('DROP TABLE tavro_user_account');
        ...
        $this->addSql('DROP TABLE tavro_contact_comment');
