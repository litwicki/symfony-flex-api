 ...
 */
class Version20161103041253 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tavro_account_freshbooks (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, auth_token VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_BDD935769315F04E (auth_token), UNIQUE INDEX UNIQ_BDD935769B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_account_harvest (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, harvest_email VARCHAR(255) NOT NULL, harvest_password VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_C36C225D450EE6D0 (harvest_email), UNIQUE INDEX UNIQ_C36C225D99A40E34 (harvest_password), UNIQUE INDEX UNIQ_C36C225D9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_account_hubspot (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, hubspot_id INT NOT NULL, api_key VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F08F39A6B9DD01AC (hubspot_id), UNIQUE INDEX UNIQ_F08F39A6C912ED9D (api_key), UNIQUE INDEX UNIQ_F08F39A69B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_account_qbo (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, consumer_key VARCHAR(255) DEFAULT NULL, consumer_secret VARCHAR(255) DEFAULT NULL, access_token VARCHAR(255) DEFAULT NULL, access_token_secret VARCHAR(255) DEFAULT NULL, realm_id INT DEFAULT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A79F19CD2702362 (consumer_key), UNIQUE INDEX UNIQ_A79F19C92086127 (consumer_secret), UNIQUE INDEX UNIQ_A79F19CB6A2DD68 (access_token), UNIQUE INDEX UNIQ_A79F19C8196DFA5 (access_token_secret), UNIQUE INDEX UNIQ_A79F19C9DFF5F89 (realm_id), UNIQUE INDEX UNIQ_A79F19C9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_account_recurly (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, api_key VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_7EE475C1C912ED9D (api_key), UNIQUE INDEX UNIQ_7EE475C1A7A91E0B (domain), UNIQUE INDEX UNIQ_7EE475C19B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_account_stripe (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, api_key VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_7ACCD10DC912ED9D (api_key), UNIQUE INDEX UNIQ_7ACCD10D9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_dashboard (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, name VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_A9EF3A289B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_dashboard_read (id INT AUTO_INCREMENT NOT NULL, metric_id INT NOT NULL, dashboard_id INT NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_762EDD41A952D583 (metric_id), INDEX IDX_762EDD41B9D04D2B (dashboard_id), UNIQUE INDEX DASHBOARD_METRIC (metric_id, dashboard_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_metric (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, name VARCHAR(255) NOT NULL, chart VARCHAR(8000) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_2838F999B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tavro_syndicate (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, body VARCHAR(8000) DEFAULT NULL, status INT DEFAULT 1 NOT NULL, create_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_A3801BC2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tavro_syndicate_investor (user_id INT NOT NULL, syndicate_id INT NOT NULL, INDEX IDX_5042747A76ED395 (user_id), INDEX IDX_50427474C37717D (syndicate_id), PRIMARY KEY(user_id, syndicate_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tavro_account_chargify ADD CONSTRAINT FK_95BE76F09B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_account_freshbooks ADD CONSTRAINT FK_BDD935769B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_account_harvest ADD CONSTRAINT FK_C36C225D9B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_account_hubspot ADD CONSTRAINT FK_F08F39A69B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_account_qbo ADD CONSTRAINT FK_A79F19C9B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_account_recurly ADD CONSTRAINT FK_7EE475C19B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_account_stripe ADD CONSTRAINT FK_7ACCD10D9B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_dashboard ADD CONSTRAINT FK_A9EF3A289B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        $this->addSql('ALTER TABLE tavro_dashboard_read ADD CONSTRAINT FK_762EDD41A952D583 FOREIGN KEY (metric_id) REFERENCES tavro_metric (id)');
        $this->addSql('ALTER TABLE tavro_dashboard_read ADD CONSTRAINT FK_762EDD41B9D04D2B FOREIGN KEY (dashboard_id) REFERENCES tavro_dashboard (id)');
        ...
        $this->addSql('ALTER TABLE tavro_forecast ADD CONSTRAINT FK_5E9DFF13A76ED395 FOREIGN KEY (user_id) REFERENCES tavro_user (id)');
        ...
        $this->addSql('ALTER TABLE tavro_metric ADD CONSTRAINT FK_2838F999B6B5FBA FOREIGN KEY (account_id) REFERENCES tavro_account (id)');
        ...
        $this->addSql('ALTER TABLE tavro_syndicate ADD CONSTRAINT FK_A3801BC2A76ED395 FOREIGN KEY (user_id) REFERENCES tavro_user (id)');
        $this->addSql('ALTER TABLE tavro_syndicate_investor ADD CONSTRAINT FK_5042747A76ED395 FOREIGN KEY (user_id) REFERENCES tavro_syndicate (id)');
        $this->addSql('ALTER TABLE tavro_syndicate_investor ADD CONSTRAINT FK_50427474C37717D FOREIGN KEY (syndicate_id) REFERENCES tavro_user (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tavro_account_harvest DROP FOREIGN KEY FK_C36C225D9B6B5FBA');
        $this->addSql('ALTER TABLE tavro_account_hubspot DROP FOREIGN KEY FK_F08F39A69B6B5FBA');
        $this->addSql('ALTER TABLE tavro_account_qbo DROP FOREIGN KEY FK_A79F19C9B6B5FBA');
        $this->addSql('ALTER TABLE tavro_account_recurly DROP FOREIGN KEY FK_7EE475C19B6B5FBA');
        $this->addSql('ALTER TABLE tavro_account_stripe DROP FOREIGN KEY FK_7ACCD10D9B6B5FBA');
        $this->addSql('ALTER TABLE tavro_account_user DROP FOREIGN KEY FK_FDD3EF999B6B5FBA');
        $this->addSql('ALTER TABLE tavro_dashboard DROP FOREIGN KEY FK_A9EF3A289B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_metric DROP FOREIGN KEY FK_2838F999B6B5FBA');
        ...
        $this->addSql('ALTER TABLE tavro_forecast_comment DROP FOREIGN KEY FK_A6E5BBDEF8697D13');
        ...
        $this->addSql('ALTER TABLE tavro_dashboard_read DROP FOREIGN KEY FK_762EDD41B9D04D2B');
        ...
        $this->addSql('ALTER TABLE tavro_dashboard_read DROP FOREIGN KEY FK_762EDD41A952D583');
        ...
        $this->addSql('ALTER TABLE tavro_syndicate_investor DROP FOREIGN KEY FK_5042747A76ED395');
        ...
        $this->addSql('ALTER TABLE tavro_forecast DROP FOREIGN KEY FK_5E9DFF13A76ED395');
        ...
        $this->addSql('ALTER TABLE tavro_syndicate DROP FOREIGN KEY FK_A3801BC2A76ED395');
        $this->addSql('ALTER TABLE tavro_syndicate_investor DROP FOREIGN KEY FK_50427474C37717D');
        $this->addSql('ALTER TABLE tavro_user_role DROP FOREIGN KEY FK_D8930373A76ED395');
        $this->addSql('DROP TABLE tavro_account');
        $this->addSql('DROP TABLE tavro_account_chargify');
        $this->addSql('DROP TABLE tavro_account_freshbooks');
        $this->addSql('DROP TABLE tavro_account_group');
        $this->addSql('DROP TABLE tavro_account_group_user');
        $this->addSql('DROP TABLE tavro_account_harvest');
        $this->addSql('DROP TABLE tavro_account_hubspot');
        $this->addSql('DROP TABLE tavro_account_qbo');
        $this->addSql('DROP TABLE tavro_account_recurly');
        $this->addSql('DROP TABLE tavro_account_stripe');
        $this->addSql('DROP TABLE tavro_account_user');
        $this->addSql('DROP TABLE tavro_comment');
        $this->addSql('DROP TABLE tavro_contact');
        $this->addSql('DROP TABLE tavro_dashboard');
        $this->addSql('DROP TABLE tavro_dashboard_read');
        ...
        $this->addSql('DROP TABLE tavro_forecast_comment');
        ...
        $this->addSql('DROP TABLE tavro_metric');
        ...
        $this->addSql('DROP TABLE tavro_syndicate');
        $this->addSql('DROP TABLE tavro_syndicate_investor');
